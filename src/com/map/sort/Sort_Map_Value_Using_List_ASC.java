...
public class Sort_Map_Value_Using_List_ASC {
    private static Map<String, Integer> sortMapValueListAsc(Map<String, Integer> unsortMap) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSorted Map......By Value");
        Map<String, Integer> sortedMap = sortMapValueListAsc(unSortMap);
        printMap(sortedMap);
    }//main
}
